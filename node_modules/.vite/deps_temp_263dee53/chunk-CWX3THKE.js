...
var require_types = __commonJS({
  "node_modules/@solana/wallet-adapter-base/lib/cjs/types.js"(exports) {
    ...
    var WalletAdapterNetwork2;
    (function(WalletAdapterNetwork3) {
      WalletAdapterNetwork3["Mainnet"] = "mainnet-beta";
      WalletAdapterNetwork3["Testnet"] = "testnet";
      WalletAdapterNetwork3["Devnet"] = "devnet";
    })(WalletAdapterNetwork2 || (exports.WalletAdapterNetwork = WalletAdapterNetwork2 = {}));
  }
});
...
var SOLANA_MAINNET_CHAIN, SOLANA_DEVNET_CHAIN, SOLANA_TESTNET_CHAIN, SOLANA_LOCALNET_CHAIN;
var init_esm = __esm({
  "node_modules/@solana/wallet-standard-chains/lib/esm/index.js"() {
...
var DOMAIN, ADDRESS, STATEMENT, URI, VERSION, CHAIN_ID, NONCE, ISSUED_AT, EXPIRATION_TIME, NOT_BEFORE, REQUEST_ID, RESOURCES, FIELDS, MESSAGE;
var init_signIn = __esm({
  "node_modules/@solana/wallet-standard-util/lib/esm/signIn.js"() {
    ...
    RESOURCES = "(?:\\nResources:(?<resources>(?:\\n- [^\\n]+)*))?";
    FIELDS = `${URI}${VERSION}${CHAIN_ID}${NONCE}${ISSUED_AT}${EXPIRATION_TIME}${NOT_BEFORE}${REQUEST_ID}${RESOURCES}`;
    MESSAGE = new RegExp(`^${DOMAIN}${ADDRESS}${STATEMENT}${FIELDS}\\n*$`);
  }
});
...
var SolanaMobileWalletAdapterErrorCode, SolanaMobileWalletAdapterError, SolanaMobileWalletAdapterProtocolErrorCode, SolanaMobileWalletAdapterProtocolError, SolanaSignTransactions, SolanaCloneAuthorization, SolanaSignInWithSolana, SEQUENCE_NUMBER_BYTES, INITIALIZATION_VECTOR_BYTES, ENCODED_PUBLIC_KEY_LENGTH_BYTES, _utf8Decoder, INTENT_NAME, Browser, _frame, WEBSOCKET_CONNECTION_CONFIG, WEBSOCKET_PROTOCOL_BINARY, WEBSOCKET_PROTOCOL_BASE64;
var init_index_browser = __esm({
  "node_modules/@solana-mobile/wallet-standard-mobile/node_modules/@solana-mobile/mobile-wallet-adapter-protocol/lib/esm/index.browser.js"() {
    ...
    SolanaMobileWalletAdapterProtocolError = class extends Error {
      constructor(...args) {
    ...
    SolanaSignTransactions = "solana:signTransactions";
    SolanaCloneAuthorization = "solana:cloneAuthorization";
    SolanaSignInWithSolana = "solana:signInWithSolana";
    SEQUENCE_NUMBER_BYTES = 4;
    INITIALIZATION_VECTOR_BYTES = 12;
    ENCODED_PUBLIC_KEY_LENGTH_BYTES = 65;
    INTENT_NAME = "solana-wallet";
    Browser = {
      Firefox: 0,
      Other: 1
    };
    ...
    WEBSOCKET_PROTOCOL_BINARY = "com.solana.mobilewalletadapter.v1";
    WEBSOCKET_PROTOCOL_BASE64 = "com.solana.mobilewalletadapter.v1.base64";
  }
});
...
var require_index_browser = __commonJS({
  "node_modules/@solana-mobile/wallet-standard-mobile/lib/cjs/index.browser.js"(exports) {
    ...
    var mobileWalletAdapterProtocol = (init_index_browser(), __toCommonJS(index_browser_exports));
...
`;
    ...
    var LocalSolanaMobileWalletAdapterWallet = class {
      constructor(config) {
        ...
        _LocalSolanaMobileWalletAdapterWallet_transact.set(this, (callback) => __awaiter2(this, void 0, void 0, function* () {
          ...
          try {
            return yield mobileWalletAdapterProtocol.transact(callback, config2);
          } catch (e) {
          ...
          try {
            ...
            return {
              account: Object.assign(Object.assign({}, signedInAccount !== null && signedInAccount !== void 0 ? signedInAccount : {
                address: base58__default["default"].encode(toUint8Array2(signedInAddress))
    ...
    var RegisterWalletEvent = class extends Event {
      constructor(callback) {
        ...
        _RegisterWalletEvent_detail2.set(this, void 0);
        __classPrivateFieldSet5(this, _RegisterWalletEvent_detail2, callback, "f");
      }
      get detail() {
        return __classPrivateFieldGet5(this, _RegisterWalletEvent_detail2, "f");
      }
      get type() {
            ...
            try {
              ...
              if (parsed && parsed.accounts) {
                const parsedAccounts = parsed.accounts.map((account) => {
                  return Object.assign(Object.assign({}, account), { publicKey: "publicKey" in account ? new Uint8Array(Object.values(account.publicKey)) : base58__default["default"].decode(account.address) });
                });
...
var require_index_browser2 = __commonJS({
  "node_modules/@solana-mobile/wallet-adapter-mobile/lib/cjs/index.browser.js"(exports) {
    ...
    var walletStandardFeatures = require_cjs();
    var walletStandardMobile = require_index_browser();
    function __awaiter2(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
          resolve(value);
    ...
    var BaseSolanaMobileWalletAdapter = class extends walletAdapterBase.BaseSignInMessageSignerWalletAdapter {
      constructor(wallet, config) {
        ...
        _BaseSolanaMobileWalletAdapter_handleChangeEvent.set(this, (properties) => __awaiter2(this, void 0, void 0, function* () {
          if (properties.accounts && properties.accounts.length > 0) {
            __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_declareWalletAsInstalled).call(this);
            const nextSelectedAccount = yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_accountSelector, "f").call(this, properties.accounts);
            if (nextSelectedAccount !== __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_selectedAccount, "f")) {
              __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_selectedAccount, nextSelectedAccount, "f");
              __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_publicKey, void 0, "f");
              this.emit(
                "connect",
        ...
        __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_accountSelector, (accounts) => __awaiter2(this, void 0, void 0, function* () {
          var _a;
        ...
        __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_wallet, wallet, "f");
        __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[StandardEvents2].on("change", __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_handleChangeEvent, "f"));
        this.name = __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").name;
        this.icon = __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").icon;
        this.url = __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").url;
      }
      get publicKey() {
        var _a;
        if (!__classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_publicKey, "f") && __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_selectedAccount, "f")) {
          try {
            __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_publicKey, new web3_js.PublicKey(__classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_selectedAccount, "f").publicKey), "f");
          } catch (e) {
            throw new walletAdapterBase.WalletPublicKeyError(e instanceof Error && (e === null || e === void 0 ? void 0 : e.message) || "Unknown error", e);
          }
        }
        return (_a = __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_publicKey, "f")) !== null && _a !== void 0 ? _a : null;
      }
      get connected() {
        return __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").connected;
      }
      get connecting() {
        return __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_connecting, "f");
      }
      get readyState() {
        return __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_readyState, "f");
      }
      ...
      autoConnect() {
        return __awaiter2(this, void 0, void 0, function* () {
          __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_connect).call(this, true);
        });
      }
      connect() {
        return __awaiter2(this, void 0, void 0, function* () {
          __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_connect).call(this);
        });
      }
      ...
      performAuthorization(signInPayload) {
        return __awaiter2(this, void 0, void 0, function* () {
          try {
            const cachedAuthorizationResult = yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").cachedAuthorizationResult;
            if (cachedAuthorizationResult) {
              yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[StandardConnect2].connect({ silent: true });
              return cachedAuthorizationResult;
            }
            if (signInPayload) {
              yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[walletStandardFeatures.SolanaSignIn].signIn(signInPayload);
            } else
              yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[StandardConnect2].connect();
            const authorizationResult = yield yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").cachedAuthorizationResult;
            return authorizationResult;
          } catch (e) {
      ...
      disconnect() {
        return __awaiter2(this, void 0, void 0, function* () {
          return yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_runWithGuard).call(this, () => __awaiter2(this, void 0, void 0, function* () {
            __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_connecting, false, "f");
            __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_publicKey, void 0, "f");
            __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_selectedAccount, void 0, "f");
            yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[StandardDisconnect2].disconnect();
      ...
      signIn(input) {
        return __awaiter2(this, void 0, void 0, function* () {
          return __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_runWithGuard).call(this, () => __awaiter2(this, void 0, void 0, function* () {
            var _a;
            if (__classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_readyState, "f") !== walletAdapterBase.WalletReadyState.Installed && __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_readyState, "f") !== walletAdapterBase.WalletReadyState.Loadable) {
              throw new walletAdapterBase.WalletNotReadyError();
            }
            __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_connecting, true, "f");
            try {
              const outputs = yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[walletStandardFeatures.SolanaSignIn].signIn(Object.assign(Object.assign({}, input), { domain: (_a = input === null || input === void 0 ? void 0 : input.domain) !== null && _a !== void 0 ? _a : window.location.host }));
              if (outputs.length > 0) {
                return outputs[0];
              } else {
                throw new Error("Sign in failed, no sign in result returned by wallet");
      ...
      signMessage(message) {
        return __awaiter2(this, void 0, void 0, function* () {
          return yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_runWithGuard).call(this, () => __awaiter2(this, void 0, void 0, function* () {
            const account = __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_assertIsAuthorized).call(this);
            try {
              const outputs = yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[walletStandardFeatures.SolanaSignMessage].signMessage({
                account,
                message
              });
        ...
        return __awaiter2(this, void 0, void 0, function* () {
          return yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_runWithGuard).call(this, () => __awaiter2(this, void 0, void 0, function* () {
            ...
            try {
              ...
              if (walletStandardFeatures.SolanaSignAndSendTransaction in __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features) {
                const chain = chainOrClusterToChainId(__classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").currentAuthorization.chain);
                const [signature] = (yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[walletStandardFeatures.SolanaSignAndSendTransaction].signAndSendTransaction({
                  account,
                ...
                const [signedTransaction] = yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_performSignTransactions).call(this, [transaction]);
      ...
      signAllTransactions(transactions) {
        return __awaiter2(this, void 0, void 0, function* () {
          return yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_runWithGuard).call(this, () => __awaiter2(this, void 0, void 0, function* () {
            const signedTransactions = yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_performSignTransactions).call(this, transactions);
            return signedTransactions;
          }));
        });
      }
    ...
    _BaseSolanaMobileWalletAdapter_wallet = /* @__PURE__ */ new WeakMap(), _BaseSolanaMobileWalletAdapter_connecting = /* @__PURE__ */ new WeakMap(), _BaseSolanaMobileWalletAdapter_readyState = /* @__PURE__ */ new WeakMap(), _BaseSolanaMobileWalletAdapter_accountSelector = /* @__PURE__ */ new WeakMap(), _BaseSolanaMobileWalletAdapter_selectedAccount = /* @__PURE__ */ new WeakMap(), _BaseSolanaMobileWalletAdapter_publicKey = /* @__PURE__ */ new WeakMap(), _BaseSolanaMobileWalletAdapter_handleChangeEvent = /* @__PURE__ */ new WeakMap(), _BaseSolanaMobileWalletAdapter_instances = /* @__PURE__ */ new WeakSet(), _BaseSolanaMobileWalletAdapter_connect = function _BaseSolanaMobileWalletAdapter_connect2(autoConnect = false) {
      return __awaiter2(this, void 0, void 0, function* () {
        ...
        return yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_runWithGuard).call(this, () => __awaiter2(this, void 0, void 0, function* () {
          ...
          __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_connecting, true, "f");
          try {
            yield __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[StandardConnect2].connect({ silent: autoConnect });
          } catch (e) {
            throw new walletAdapterBase.WalletConnectionError(e instanceof Error && e.message || "Unknown error", e);
          } finally {
            __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_connecting, false, "f");
      ...
      if (__classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_readyState, "f") !== walletAdapterBase.WalletReadyState.Installed) {
        this.emit("readyStateChange", __classPrivateFieldSet5(this, _BaseSolanaMobileWalletAdapter_readyState, walletAdapterBase.WalletReadyState.Installed, "f"));
      }
    }, _BaseSolanaMobileWalletAdapter_assertIsAuthorized = function _BaseSolanaMobileWalletAdapter_assertIsAuthorized2() {
      if (!__classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").isAuthorized || !__classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_selectedAccount, "f"))
        throw new walletAdapterBase.WalletNotConnectedError();
      return __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_selectedAccount, "f");
      ...
      return __awaiter2(this, void 0, void 0, function* () {
        const account = __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_instances, "m", _BaseSolanaMobileWalletAdapter_assertIsAuthorized).call(this);
        try {
          if (walletStandardFeatures.SolanaSignTransaction in __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features) {
            return __classPrivateFieldGet5(this, _BaseSolanaMobileWalletAdapter_wallet, "f").features[walletStandardFeatures.SolanaSignTransaction].signTransaction(...transactions.map((value) => {
...
var import_wallet_adapter_mobile2 = __toESM(require_index_browser2(), 1);
...
_StandardWalletAdapter_account = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_publicKey = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_connecting = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_disconnecting = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_off = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_supportedTransactionVersions = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_wallet = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_readyState = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_changed = /* @__PURE__ */ new WeakMap(), _StandardWalletAdapter_instances = /* @__PURE__ */ new WeakSet(), _StandardWalletAdapter_connect = async function _StandardWalletAdapter_connect2(input) {
  ...
  __classPrivateFieldSet2(this, _StandardWalletAdapter_supportedTransactionVersions, arraysEqual2(supportedTransactionVersions, ["legacy"]) ? null : new Set(supportedTransactionVersions), "f");
...
_SolanaWalletAdapterWallet_listeners = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_adapter = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_supportedTransactionVersions = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_chain = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_endpoint = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_account = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_connect = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_disconnect = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_on = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signAndSendTransaction = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signTransaction = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signMessage = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_signIn = /* @__PURE__ */ new WeakMap(), _SolanaWalletAdapterWallet_instances = /* @__PURE__ */ new WeakSet(), _SolanaWalletAdapterWallet_connected = function _SolanaWalletAdapterWallet_connected2() {
  ...
  if (publicKey) {
    ...
    if (!account || account.address !== address || account.chains.includes(__classPrivateFieldGet4(this, _SolanaWalletAdapterWallet_chain, "f")) || !bytesEqual2(account.publicKey, publicKey)) {
  ...
  if (transaction.version === "legacy" && arraysEqual2(__classPrivateFieldGet4(this, _SolanaWalletAdapterWallet_supportedTransactionVersions, "f"), ["legacy"]))
...
var import_wallet_adapter_mobile = __toESM(require_index_browser2(), 1);
var Environment;
...
//# sourceMappingURL=chunk-CWX3THKE.js.map
