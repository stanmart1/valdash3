          ...
          <button
            ...
            className={`relative whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors ${
              activeTab === tab.id
                ...
                : 'border-transparent text-muted hover:text-secondary hover:border-gray-300 dark:hover:text-gray-100'
            }`}
          >
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center p-4 rounded-lg border-2 transition-all ${
              activeTab === tab.id
                ...
                : 'border-card text-secondary hover:border-gray-300 dark:hover:border-gray-600 hover-card'
            }`}
          >
