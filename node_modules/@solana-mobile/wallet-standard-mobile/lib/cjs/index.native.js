        ...
        _RemoteSolanaMobileWalletAdapterWallet_performSignIn.set(this, (input) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return {
                    account: Object.assign(Object.assign({}, signedInAccount !== null && signedInAccount !== void 0 ? signedInAccount : {
                        address: base58__default["default"].encode(jsBase64.toUint8Array(signedInAddress))
                    }), { publicKey: jsBase64.toUint8Array(signedInAddress), chains: (_h = signedInAccount === null || signedInAccount === void 0 ? void 0 : signedInAccount.chains) !== null && _h !== void 0 ? _h : __classPrivateFieldGet$1(this, _RemoteSolanaMobileWalletAdapterWallet_chains, "f"), features: (_j = signedInAccount === null || signedInAccount === void 0 ? void 0 : signedInAccount.features) !== null && _j !== void 0 ? _j : authorizationResult.capabilities.features }),
                    signedMessage: jsBase64.toUint8Array(authorizationResult.sign_in_result.signed_message),
                    signature: jsBase64.toUint8Array(authorizationResult.sign_in_result.signature)
                };
            }
...
const isOptionObject = require$$0__default["default"];
...
function createDefaultAuthorizationCache() {
    return {
        clear() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    yield AsyncStorage.removeItem(CACHE_KEY);
        ...
        get() {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    const parsed = JSON.parse((yield AsyncStorage.getItem(CACHE_KEY)));
        ...
        set(authorizationResult) {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    yield AsyncStorage.setItem(CACHE_KEY, JSON.stringify(authorizationResult));
                    // eslint-disable-next-line no-empty
                }
                catch (_a) { }
            });
