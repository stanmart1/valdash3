...
function stringify3(x6, doExponential, isNonzero) {
...
P.sqrt = function() {
  ...
  s4 = Math.sqrt(+stringify3(x6, true, true));
  if (s4 === 0 || s4 === 1 / 0) {
    c7 = x6.c.join("");
...
P.toFixed = function(dp, rm) {
  ...
  return stringify3(x6, false, !!n5);
};
P[Symbol.for("nodejs.util.inspect.custom")] = P.toJSON = P.toString = function() {
  var x6 = this, Big2 = x6.constructor;
  return stringify3(x6, x6.e <= Big2.NE || x6.e >= Big2.PE, !!x6.c[0]);
};
P.toNumber = function() {
...
P.toPrecision = function(sd, rm) {
  ...
  return stringify3(x6, sd <= x6.e || x6.e <= Big2.NE || x6.e >= Big2.PE, !!n5);
};
P.valueOf = function() {
  var x6 = this, Big2 = x6.constructor;
  if (Big2.strict === true) {
  ...
  return stringify3(x6, x6.e <= Big2.NE || x6.e >= Big2.PE, true);
};
var Big = _Big_();
var big_default = Big;
...
var BlockchainApiController = {
  ...
  async fetchSwapQuote({ amount, userAddress, from: from21, to: to2, gasPrice }) {
    var _a;
    const isSupported = await BlockchainApiController.isNetworkSupported((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.caipNetworkId);
    if (!isSupported) {
      return { quotes: [] };
  ...
  async generateSwapCalldata({ amount, from: from21, to: to2, userAddress, disableEstimate }) {
    var _a;
    const isSupported = await BlockchainApiController.isNetworkSupported((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.caipNetworkId);
    if (!isSupported) {
  ...
  async generateApproveCalldata({ from: from21, to: to2, userAddress }) {
    var _a;
    const { st: st2, sv } = BlockchainApiController.getSdkProperties();
    const isSupported = await BlockchainApiController.isNetworkSupported((_a = ChainController.state.activeCaipNetwork) == null ? void 0 : _a.caipNetworkId);
    if (!isSupported) {
...
var __spreadArray = function(to2, from21, pack) {
  ...
  return to2.concat(ar3 || Array.prototype.slice.call(from21));
};
var BrowserInfo = (
  /** @class */
  /* @__PURE__ */ function() {
...
function checksum2(address) {
  ...
  const hash2 = keccak2562(fromString3(hexAddress), { as: "Bytes" });
...
function sr2(r3, e3) {
  ...
  function d5(l8) {
    ...
    for (var j4 = (D2 - I3) * u3 + 1 >>> 0, T4 = new Uint8Array(j4); I3 !== D2; ) {
      for (var q2 = l8[I3], J4 = 0, K5 = j4 - 1; (q2 !== 0 || J4 < x6) && K5 !== -1; K5--, J4++) q2 += 256 * T4[K5] >>> 0, T4[K5] = q2 % a3 >>> 0, q2 = q2 / a3 >>> 0;
  ...
  function g4(l8) {
    ...
    if (l8[b4] !== " ") {
      ...
      if (l8[b4] !== " ") {
        for (var K5 = D2 - I3; K5 !== D2 && j4[K5] === 0; ) K5++;
        for (var H2 = new Uint8Array(x6 + (D2 - K5)), me3 = x6; K5 !== D2; ) H2[me3++] = j4[K5++];
        return H2;
      }
    }
  }
...
var SHA1 = class extends HashMD {
  ...
  process(view, offset) {
    ...
    for (let i5 = 0; i5 < 80; i5++) {
      ...
      const T4 = rotl(A2, 5) + F3 + E4 + K5 + SHA1_W[i5] | 0;
      E4 = D2;
      D2 = C5;
      C5 = rotl(B3, 30);
      B3 = A2;
...
function decodeBytes(cursor, param, { staticPosition }) {
  const [_4, size8] = param.type.split("bytes");
  if (!size8) {
...
function encodeArray(value, options) {
  ...
  if (dynamic || dynamicChild) {
    ...
    if (dynamic) {
      ...
      return {
        dynamic: true,
        encoded: preparedParameters.length > 0 ? concat(length3, data) : length3
      };
    }
    if (dynamicChild)
...
function encodeTuple(value, options) {
  ...
  return {
    dynamic,
    encoded: dynamic ? encode8(preparedParameters) : concat(...preparedParameters.map(({ encoded }) => encoded))
  };
}
...
function invert(number, modulo) {
  ...
  let b4 = modulo;
  let x6 = _0n, y5 = _1n, u3 = _1n, v5 = _0n;
  while (a3 !== _0n) {
    const q2 = b4 / a3;
    const r3 = b4 % a3;
    const m4 = x6 - u3 * q2;
...
function weierstrass(curveDef) {
  ...
  const slcNum = (b4, from21, to2) => bytesToNumberBE(b4.slice(from21, to2));
  class Signature {
...
function hash_to_field(msg, count, options) {
  ...
  const { p: p4, k: k5, m: m4, hash: hash2, expand, DST: _DST } = options;
  abytes(msg);
  anum(count);
...
function lift_x(x6) {
  aInRange("x", x6, _1n4, secp256k1P);
  const xx = modP(x6 * x6);
  const c7 = modP(xx * x6 + BigInt(7));
  let y5 = sqrtMod(c7);
  if (y5 % _2n3 !== _0n4)
    y5 = modP(-y5);
  const p4 = new Point(x6, y5, _1n4);
  p4.assertValidity();
  return p4;
}
...
function hash(authorization, options = {}) {
  ...
  return keccak2564(concat("0x05", fromHex5(toTuple2(presign ? {
    address: authorization.address,
...
function recoverPublicKey3(options) {
  ...
  const { r: r3, s: s4, yParity } = signature;
  const signature_ = new secp256k12.Signature(BigInt(r3), BigInt(s4)).addRecoveryBit(yParity);
...
function unwrap(wrapped) {
  ...
  const [auth, to2, data] = decode7(suffixParameters, suffix);
...
function unwrap2(wrapped) {
  assert6(wrapped);
  const [to2, data, signature] = decode7(from12("address, bytes, bytes"), wrapped);
  return { data, signature, to: to2 };
}
function wrap2(value) {
  const { data, signature, to: to2 } = value;
  return concat(encode9(from12("address, bytes, bytes"), [
    to2,
    data,
    signature
  ]), magicBytes2);
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-3MPC3G5E.js.map
