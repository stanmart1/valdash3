...
export type BridgeCommonErrors = typeof ERRORS.HTTP_ERROR | typeof ERRORS.WRONG_RESULT_TYPE | typeof ERRORS.UNEXPECTED_ERROR;
...
export declare class BridgeTransport extends AbstractTransport {
    ...
    private listenLoop;
    enumerate({ signal }?: AbstractTransportMethodParams<'enumerate'>): Promise<import("../types").Success<Descriptor[]> | {
        success: false;
        error: BridgeCommonErrors;
        message?: string;
    } | {
    ...
    acquire({ input, signal }: AbstractTransportMethodParams<'acquire'>): Promise<import("../types").Success<Session> | {
        success: false;
        error: "Unable to open device" | "device not found" | "wrong previous session" | BridgeCommonErrors;
        message?: string;
    } | {
        success: false;
    ...
    release({ path: _, session, signal }: AbstractTransportMethodParams<'release'>): Promise<{
        success: false;
        error: NonNullable<"Aborted by signal" | "Aborted by timeout">;
        message: string | undefined;
    } | {
        ...
        success: false;
        error: "session not found" | BridgeCommonErrors;
        message?: string;
    } | import("../types").Success<null>>;
    releaseSync(session: Session): void;
    releaseDevice(): Promise<import("../types").Success<undefined>>;
    private getProtocol;
    private getRequestBody;
    call({ session, name, data, protocol: customProtocol, thpState, signal, timeout, }: AbstractTransportMethodParams<'call'>): Promise<{
        success: false;
        ...
        success: false;
        error: "device disconnected during action" | "other call in progress" | "Malformed protocol format" | BridgeCommonErrors;
        message?: string;
    } | import("../types").Success<import("@trezor/protocol/lib/protocol-thp").ThpMessageResponse>>;
    send({ session, name, data, protocol: customProtocol, thpState, signal, timeout, }: AbstractTransportMethodParams<'send'>): Promise<import("../types").Success<undefined> | {
        success: false;
        error: NonNullable<"Aborted by signal" | "Aborted by timeout">;
        message: string | undefined;
    } | {
    ...
    receive({ session, protocol: customProtocol, thpState, signal, timeout, }: AbstractTransportMethodParams<'receive'>): Promise<{
        success: false;
        error: "Unable to open device" | "A transfer error has occurred." | "device not found" | "device disconnected during action" | "unexpected error" | "Aborted by signal" | "Aborted by timeout";
        message?: string;
    } | import("../types").Success<{
