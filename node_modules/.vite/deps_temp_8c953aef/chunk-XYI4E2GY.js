...
var ICONS = {
  add: async () => (await import("./add-MVM4EGY2.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-YORNP3C5.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-QQ3LK67S.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-OK3YSJO5.js")).appStoreSvg,
  apple: async () => (await import("./apple-M6XNKRAF.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-KPFACRSD.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-CE762NTB.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-UK5MZC4V.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-EXOYTGOX.js")).arrowTopSvg,
  bank: async () => (await import("./bank-L7DZZCSU.js")).bankSvg,
  browser: async () => (await import("./browser-O4N76JLX.js")).browserSvg,
  card: async () => (await import("./card-6DVMATQO.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-7QDUMVCE.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-7ZDA33QP.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-SVXE3BL7.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-Z7Z7IGNT.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-WYVPOQHL.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-RFTZYKGZ.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-T2OELRV2.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-P3LI77LU.js")).clockSvg,
  close: async () => (await import("./close-P26J5NVI.js")).closeSvg,
  compass: async () => (await import("./compass-NQITBJCS.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ST6CGVTB.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-LQ76DZFT.js")).copySvg,
  cursor: async () => (await import("./cursor-PMQJD5A2.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-QH5Q7RVI.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-L3WNO7GD.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-6MZDAFCS.js")).disconnectSvg,
  discord: async () => (await import("./discord-N6CFM3LG.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-D4QZD3O4.js")).etherscanSvg,
  extension: async () => (await import("./extension-B4EPC673.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-TCYQYXSJ.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-2BOK6HIO.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-TUFPYELI.js")).farcasterSvg,
  filters: async () => (await import("./filters-QPKWXGY5.js")).filtersSvg,
  github: async () => (await import("./github-VJNHWZTJ.js")).githubSvg,
  google: async () => (await import("./google-2PLU4GA2.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-QQZH2Q4T.js")).helpCircleSvg,
  image: async () => (await import("./image-WVTKNH6D.js")).imageSvg,
  id: async () => (await import("./id-HSTKJKYE.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-QB3MWWKM.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-WDBRNOON.js")).lightbulbSvg,
  mail: async () => (await import("./mail-UOPOWRIW.js")).mailSvg,
  mobile: async () => (await import("./mobile-3MZ6QNY4.js")).mobileSvg,
  more: async () => (await import("./more-HG265UI5.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-UQBCZJZ4.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-2SH2EEMZ.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-UPMACJOB.js")).offSvg,
  playStore: async () => (await import("./play-store-SAUCDGZH.js")).playStoreSvg,
  plus: async () => (await import("./plus-XEM6N6F7.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-FUFEZAAL.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-2M4WNEYZ.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-SJYFO7TK.js")).refreshSvg,
  search: async () => (await import("./search-OE5TGTD3.js")).searchSvg,
  send: async () => (await import("./send-QEF6X34Y.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-H7OETMKA.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-52IY2YZG.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-YFRRVTIO.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-JXS2NSGE.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-KJC5DRYM.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-FK2DAWHP.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-D67NZAXT.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-ZW52H7QP.js")).twitchSvg,
  twitter: async () => (await import("./x-MS7CHLH7.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-A7M2OC3H.js")).twitterIconSvg,
  verify: async () => (await import("./verify-6ON3J3JY.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-SASVXMOL.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-A26C5EMS.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-CI3Z2MC3.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-CI3Z2MC3.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-CI3Z2MC3.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-B3M6B6RB.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-REQKG5WH.js")).warningCircleSvg,
  x: async () => (await import("./x-MS7CHLH7.js")).xSvg,
  info: async () => (await import("./info-RGRE26PX.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-AYEHKSTN.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-HXVZEDYO.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XYI4E2GY.js.map
